  ...
  const handleDelete = (id, title) => {
    toast.custom((t) => (
      <div
        ...
        } max-w-md w-full bg-white shadow-xl rounded-lg pointer-events-auto flex flex-col ring-1 ring-black ring-opacity-5 border border-gray-200`}
      >
        {/* Header */}
        ...
        <div className="p-4">
          <p className="text-sm text-gray-600">
            Are you sure you want to delete <span className="font-medium text-gray-900">"{title || 'Untitled Article'}"</span>? 
        ...
        <div className="flex border-t border-gray-200">
          <button
            onClick={() => toast.dismiss(t.id)}
            className="flex-1 py-3.5 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors border-r border-gray-200 rounded-bl-lg"
          >
            Cancel
          </button>
          <button
            onClick={() => {
              ...
              toast.promise(
                ...
                }),
                {
                  ...
                  error: (err) => {
                    const errorMsg = err?.response?.data?.message || err?.message || 'Failed to delete article';
                    return (
                      <div className="flex items-center">
            ...
            className="flex-1 py-3.5 px-4 text-sm font-medium text-red-600 hover:text-red-700 hover:bg-red-50 transition-colors rounded-br-lg"
          >
            Delete Article
          </button>
        </div>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <div className="flex items-center space-x-2">
                            ...
                            <button
                              ...
                              onClick={() => handleDelete(item._id || item.id, item.title || 'Untitled Article')}
                              title="Delete"
                            >
