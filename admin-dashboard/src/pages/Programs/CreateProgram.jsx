      ...
      <div className="group">
        ...
        {name === 'description' && (
          <div className="mt-2 flex justify-between items-center text-xs">
            ...
            <span className={`font-medium ${form.description.length > 900 ? 'text-amber-600' : 'text-gray-500'}`}>
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Set up a new program with detailed information</p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-gradient-to-r from-red-50 to-red-50/50 border-l-4 border-red-500 p-5 m-6 rounded-xl">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <h3 className="font-semibold text-red-900 mb-1">Error Creating Program</h3>
              ...
              <button
                ...
                className={`w-full sm:w-auto px-8 py-3.5 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center gap-2 min-w-[180px] ${
                  loading || !isFormValid()
                    ...
                    : 'bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:from-blue-700 hover:to-blue-800 shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 focus:ring-4 focus:ring-blue-200'
                }`}
              >
                {loading ? (
                  <>
