      ...
      <div className="bg-gradient-to-r from-primary-700 to-primary-800 py-12">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h3 className="text-2xl font-bold font-display mb-4">Stay Updated with Our Work</h3>
            ...
            <form className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-grow px-4 py-3 rounded-lg bg-white/10 border border-white/20 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-transparent"
              />
              <button
                type="submit"
                className="px-6 py-3 bg-white text-primary-700 rounded-lg font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center"
              >
                Subscribe
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              <div className="flex items-center space-x-3">
                <div className="w-14 h-14 bg-gradient-to-r from-primary-500 to-primary-600 rounded-full flex items-center justify-center shadow-lg">
                  <span className="text-white font-bold text-xl">MTC</span>
                </div>
                <div>
                  <h3 className="text-xl font-bold font-display">Matakiri Tumaini Centre</h3>
                ...
                <ul className="space-y-3">
                  {links.map((link) => (
                    <li key={link.to}>
                      ...
                      >
                        <span className="w-1 h-1 bg-primary-500 rounded-full mr-3 group-hover:scale-125 transition-transform"></span>
                        <span>{link.label}</span>
                      </Link>
                    </li>
                  ))}
      ...
      <div className="border-t border-gray-800 py-6">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-400 text-sm mt-2 md:mt-0 flex gap-4">
